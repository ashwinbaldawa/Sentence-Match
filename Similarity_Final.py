...
train_df = pd.read_csv(r"C:\Users\ashwin\PycharmProjects\similarity\Match Finder\sample\Train_new.csv")
tot_q = len(train_df)
...
for indr,rows in final_df.iloc[:,1:].head(tot_q).iterrows():
...
Final_temp = Final_temp[Final_temp.astype(str)['Target'] != '[]']
Final_temp['Q ID'] = Final_temp.index
Final_temp.index = range(len(Final_temp))

print(Cosine_df.info())
print(Final_temp.info())
...
Final_temp.to_json(r'C:\Users\ashwin\PycharmProjects\similarity\Match Finder\sample\algorithm\Nodes.json')
Cosine_df.to_json(r'C:\Users\ashwin\PycharmProjects\similarity\Match Finder\sample\algorithm\Edges.json')
#import pickle
...
#os.remove('C:/Users/ashwin/PycharmProjects/similarity/Match Finder/sample/algorithm/Edges.csv')
